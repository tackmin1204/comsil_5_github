...
template <typename T2>
void LinkedList<T2>::Insert(T2 element){
	//노드 생성
	Node<T2> *newnode = new Node<T2>(element);
...
template <typename T2>
bool LinkedList<T2>::Delete(T2 &element){

	if (first == 0)
		return false;
	
	Node<T2> *current = first;
	Node<T2> *previous = 0;
